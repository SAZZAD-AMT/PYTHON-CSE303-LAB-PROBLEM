...
This [GitHub repo](https://github.com/neodynamic/JSPrintManager/) contains the source code of [JSPrintManager Online Demo Website](https://jsprintmanager.azurewebsites.net)
